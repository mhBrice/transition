...
pdf("res/figS_hist_intervals.pdf", width = 4.5, height = 6.5)
#quartz(width = 4.5, height = 6.5)
...
mtext("Time intervals between survey (years)", 1, outer = T, line = -1.2, cex = 0.85, font = 2)
mtext("Frequency of forest plots", 2, outer = T, line = -1.3, cex = 0.85, font = 2)
